  ...
  return (
    <div className="space-y-4">
      ...
      <input
        ...
        className="w-full px-3 py-2 text-sm border border-gray-200 rounded-md focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-300 transition"
      />
          ...
          <button
            ...
            className={`px-3 py-1.5 text-sm rounded-md font-medium transition-all ${
              selectedTypes.has(type)
                ...
                : 'bg-gray-100 text-gray-700 border border-gray-200 hover:bg-blue-50 hover:border-blue-200'
            }`}
          >
