...
import { coverLetterToPlainText } from '@/lib/coverLetterPlainText'
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const text = coverLetterToPlainText(clData)

    const filename = `${application.company_name}_${application.job_title}_CoverLetter.txt`
